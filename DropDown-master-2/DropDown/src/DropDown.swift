...
public final class DropDown: UIView {
	...
	*/
    ...
    public dynamic var separatorInsetLeft = DPDConstant.UI.SeparatorInsetLeft {
        willSet { tableView.separatorInset.left = newValue }
        didSet { reloadAllComponents() }
    }
    
    public dynamic var separatorInsetRight = DPDConstant.UI.SeparatorInsetRight {
        willSet { tableView.separatorInset.right = newValue }
        didSet { reloadAllComponents() }
    }
	...
	*/
    ...
    public dynamic var textAligment = DPDConstant.UI.TextAligment {
        didSet { reloadAllComponents() }
    }
...
private extension DropDown {
	...
	func setupUI() {
        ...
        tableView.separatorInset.left = separatorInsetLeft
        tableView.separatorInset.right = separatorInsetRight
...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
	...
	fileprivate func configureCell(_ cell: DropDownCell, at index: Int) {
        ...
        cell.optionLabel.textAlignment = textAligment
